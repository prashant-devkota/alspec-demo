...
export const COLOR_1_MEDIUM = twColor.indigo['300']
export const COLOR_2_MEDIUM = twColor.blue['300']
export const COLOR_3_MEDIUM = twColor.emerald['300']
export const COLOR_4_MEDIUM = twColor.amber['300']
export const COLOR_5_MEDIUM = twColor.red['300']
export const COLOR_6_MEDIUM = twColor.purple['300']
export const COLOR_7_MEDIUM = twColor.cyan['300']
